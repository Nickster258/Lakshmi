...
import com.nickster258.lakshmi.parsers.*;
import com.nickster258.lakshmi.handlers.*;
  ...
  public static void listener() {
    ...
    while ((line = BOT.readLine( )) != null) {
      ...
      // Complicated COMMANDS
        ...
        sendUser(comm.getService(), comm.getUser(), "Complex commands (*OP required): urban define staff status uuid history calc sudo* reload* quit*");
        System.out.println("COMMAND EXECUTED: " + comm.toString());
